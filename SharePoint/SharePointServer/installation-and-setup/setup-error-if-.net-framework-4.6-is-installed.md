...
2. Download the compressed (.zip) file that contains the fix that matches the product you're installing:  
   ...
   - [SharePoint Foundation 2013 with Service Pack 1 fix](https://www.microsoft.com/en-us/download/details.aspx?id=42039)   
   - [SharePoint Server 2013 with Service Pack 1 fix](https://www.microsoft.com/en-US/download/details.aspx?id=42544)   
   - [Project Server 2013 with Service Pack 1 fix](https://www.microsoft.com/en-us/download/details.aspx?id=42545)     
